const insertMovie = (knex, movie) => {
  return knex('movie').insert({
    ...
    .then(movie_id => {
      console.log("Attempting seed movie with id:", movie_id)
      let genrePromises = [];
    ...
    .catch(err => { console.error("Error creating movie:", movie.id, err) })
}
...
exports.seed = function (knex) {
  ...
  return knex('genre').del()
    ...
    .then(() => {
      let moviePromises = [];
      movieData.forEach(movie => moviePromises.push(insertMovie(knex, movie)));
